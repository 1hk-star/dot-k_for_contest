...
public class find_path {
   ...
   char map[][] = {
    ...
    // 10,0 10,1 10,2 10,3 9,3 8,3 7,3 6,3 5,3 5,4
    public void set_path(){
        path_v = new ArrayList<path>();
        path_v.add(new path(10, 10));
        path_v.add(new path(9, 10));
        path_v.add(new path(9, 9));
        path_v.add(new path(8, 9));
        path_v.add(new path(8, 10));
    }
    ...
    public int find_direction(float maz){ //방향이 일치하면 앞으로 이동하라가 출력, 일치하지 않으면 방향을 이동하라 출력
